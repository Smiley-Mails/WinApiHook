    ...
    switch (msg)
    {
        case WM_CREATE:
        {
			...
			/*static HWND*/ hListBox = CreateWindowEx(WS_EX_CLIENTEDGE, TEXT("listbox"), NULL, 
				...
				SCALEX(5), SCALEY(255), SCALEX(340), SCALEY(120), hWnd, NULL, NULL, NULL);
			...
			HWND hGr = CreateWindowEx(WS_EX_TRANSPARENT, L"BUTTON", L"Controll", WS_CHILD | WS_VISIBLE | BS_GROUPBOX,
				SCALEX(5), SCALEY(370), SCALEX(340), SCALEY(55), hWnd, NULL, hInst, NULL);
			...
			HWND Update_Button = CreateWindow(L"button", L"Update",
                ...
                SCALEX(30), SCALEY(385), SCALEX(90), SCALEY(30), hWnd, (HMENU)1001, hInst, 0);
			...
			HWND Sel_Dll_Button = CreateWindow(L"button", L"Shoose DLL",
				WS_CHILD | WS_VISIBLE | BS_CENTER,
				SCALEX(130), SCALEY(385), SCALEX(90), SCALEY(30), hWnd, (HMENU)1002, hInst, 0);
			...
			HWND Inject_Button = CreateWindow(L"button", L"Inject",
				WS_CHILD | WS_VISIBLE | BS_CENTER,
				SCALEX(230), SCALEY(385), SCALEX(90), SCALEY(30), hWnd, (HMENU)1003, hInst, 0);
			...
			// Добавленн стль WS_VISIBLE, чтобы не нужно было отдельно вызывать ShowWindow для hList
